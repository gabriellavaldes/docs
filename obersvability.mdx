---
title: Logs
sidebarTitle: Learn about how to access and retain logs from your Aptible resources 
---

# Overview
Logs collect the output of your [Containers](core-concepts/architecture/containers/overview). 
...
# Activity Logs
Aptible stores recent activity logs for quick access. 

> 📘 For long term retention of logs, you will need to set up a [Log Drain]
