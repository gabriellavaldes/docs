---
title: Apps - Testing Doc
Category: content/docs_categories/background-information.md
Order: 1
---

import CLI from '_snippets/CLI-download.mdx';
<CLI/> 


# TESTING
Learn how Aptible streamlines app deployment, allowing developers to effortlessly push code flaws in seconds
