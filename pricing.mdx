...
<CardGroup cols={3}>
  <Card title="Uniftied Infrastructure" icon="badge-check" iconType="duotone">
  Manage your infrastructure in your own account
  </Card>
  <Card title="Leverage AWS discount & credit programs" icon="messages-dollar" iconType="duotone">
  Take advantage reserved instances, savings plans, or activate credits
  </Card>
...
| - | -------- | -------- | --------- |
| Monthly Cost | $0 | $499 | [Contact us](https://app.aptible.com/contact) |
