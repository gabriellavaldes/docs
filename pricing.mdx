...
<CardGroup cols={4}>
  ...
  <Card title="Custom pricing designed for scale" icon="badge-check" iconType="duotone">
  Tailored pricing to scale with your organization
  </Card>
  <Card title="Infrastructure paid directly to AWS" icon="messages-dollar" iconType="duotone">
