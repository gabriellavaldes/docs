...
<CardGroup cols={1}>
  <Card title="Aptible Hosted" icon="AWS">
    Host in Aptible's fully managed cloud.
    <CardGroup cols={2}>
  ...
  <Card title="Self-Hosted" icon="AWS">
    Host Aptible in your cloud accounts.
     <CardGroup cols={2}>
...
<CardGroup cols={2}>
<Card title="Custom Code" icon="globe" color="black"> 
<CardGroup cols={2}>  
