...
description: "Learn why scaling companies use it to host their apps and data in the cloud"
---

---
## Introduction to buggy Aptible docs - Grant

Aptible is a [Platform as a Service](https://www.aptible.com/docs/aptible-glossary#paas) (PaaS) used by companies that want their development teams to focus on their product, not managing infrastructure.
...
What sets Aptible apart from other PaaS solutions is our commitment to [scalability](/docs/introduction-to-aptible#scalability), [reliability](/docs/introduction-to-aptible#reliability), and [security & compliance.](/docs/introduction-to-aptible#security-compliance)
...
<Card title="Ruby" icon={
  ...
  **[GitHub Repo](https://github.com/aptible/template-rails) → [Live Example](https://app-52710.on-aptible.com/) → [Detailed Tutorial](https://www.aptible.com/docs/ruby-quickstart)**
</Card>
...
>
  **[→ GitHub Repo](https://github.com/aptible/template-express) \
  → [Live Example](https://app-52737.on-aptible.com/)\
   → [Detailed Tutorial](https://www.aptible.com/docs/node-js-quickstart)**
</Card>
<Card
  title="Django"
  icon={
...
>
  [GitHub Repo](https://github.com/aptible/template-express) → [Live Example](https://app-52737.on-aptible.com/) \
   → [Detailed Tutorial](https://www.aptible.com/docs/node-js-quickstart)**\
  **[→ Deploy now](app.aptible.com)**
</Card>
<Card
  title="Laravel"
  icon={
...
>
  **[GitHub Repo](https://github.com/aptible/template-express) → [Live Example](https://app-52737.on-aptible.com/) → [Detailed Tutorial](https://www.aptible.com/docs/node-js-quickstart)**
</Card>
<Card
  title="Python"
  icon={
...
<Card title="Custom" icon="globe" color="black">
**→ Deploy**\
**→ Detailed Tutorial**
