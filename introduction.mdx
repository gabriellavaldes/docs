...
sidebarTitle: Introduction to Aptible
...
## Choose your cloud
Deploy apps and databases to **Aptible's secure cloud** or **integrate with your cloud providers** to standardize existing infrastructure.
...
<CardGroup cols={3}>
<Card title="Custom Code" icon="globe" color="black" href=""> 
</Card>
...
<CardGroup cols={2}>  
<Card title="Deploy→ " href="https://app.aptible.com/create">   
</Card>
<Card title="Tutorial→" href="">   
</Card>
</CardGroup>
</Card>
...
<CardGroup cols={2}>
  <Card title="Troubleshooting Guides" icon="books" iconType="duotone" href="https://www.aptible.com/docs/common-erorrs">
    Hitting an Error? Oh no! Read our troubleshooting guides for common errors
  </Card>
  <Card title="Contact Support" icon="comment" iconType="duotone" href="https://aptible.zendesk.com/hc/en-us/requests/new">
